                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div id="main-preview" class="preview-container mt-2"></div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div id="detail-preview" class="preview-container mt-2"></div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="length" class="form-label fw-bold">
                                ...
                                Chiều dài <span class="text-danger">*</span>
                            </label>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="grip_size_G" class="form-label fw-bold">
                                ...
                                Kích thước cán <span class="text-danger">*</span>
                            </label>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="lbs" class="form-label fw-bold">
                                ...
                                Sức căng (lbs) <span class="text-danger">*</span>
                            </label>
                            <select name="lbs" id="lbs" class="form-select form-select-lg" required>
                                ...
                                @foreach ($lbsOptions as $lbs)
                                    <option value="{{ $lbs }}"
                                        {{ old('lbs', $extend->lbs ?? '') == $lbs ? 'selected' : '' }}>{{ $lbs }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="balance" class="form-label fw-bold">
                                ...
                                Độ cân bằng <span class="text-danger">*</span>
                            </label>
                            <select name="balance" id="balance" class="form-select form-select-lg" required>
                                ...
                                @foreach ($balanceOptions as $option)
                                    <option value="{{ $option }}"
                                        {{ old('balance', $extend->balance ?? '') == $option ? 'selected' : '' }}>
                                        {{ $option }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="stiffness" class="form-label fw-bold">
                                ...
                                Độ cứng <span class="text-danger">*</span>
                            </label>
                            <select name="stiffness" id="stiffness" class="form-select form-select-lg" required>
                                <option value="">-- Chọn độ cứng --</option>
                                @foreach ($stiffnessOptions as $stiff)
                                    <option value="{{ $stiff }}"
                                        {{ old('stiffness', $extend->stiffness ?? '') == $stiff ? 'selected' : '' }}>
                                        {{ $stiff }}</option>
                                @endforeach
                            </select>
                        </div>
