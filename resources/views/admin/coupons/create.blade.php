...
@section('main')
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                <form action="{{ route('admin.coupon.store') }}" method="POST" id="createCouponForm">
                    @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('discount_type') is-invalid @enderror"
                                        ...
                                        <option value="Fixed Amount"
                                            {{ old('discount_type') == 'Fixed Amount' ? 'selected' : '' }}>Số tiền cố định
                                            (VNĐ)</option>
                                    </select>
                                    @error('discount_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01"
                                        ...
                                        value="{{ old('min_order_amount', 0.0) }}">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ old('total_usage_limit') }}" placeholder="Để trống nếu không giới hạn">
...
@push('styles')
    {{-- <link rel="stylesheet" href="{{ asset('assets/admin/css/coupons/create.css') }}"> --}}
@endpush

@push('scripts')
    {{-- Có thể thêm JS cho date/time picker ở đây nếu cần --}}
    {{-- <script src="{{ asset('assets/admin/js/coupons/create.js') }}"></script> --}}
@endpush
